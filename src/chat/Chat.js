        ...
        <div>
            ...
            <div className="container-fluid" id="screen">
                <div id="chats" className="row card flex-row">
                    ...
                    <MainScreen user={user} dataBase={dataBase} myMessages={myMessages} setMyMessages={setMyMessages} showUploadModal={showUploadModal}
                    setShowUploadModal={setShowUploadModal} showRecorderModal={showRecorderModal} setShowRecorderModal={setShowRecorderModal}
                    userAudioBlob={userAudioBlob} setUserBlob={setUserBlob}/>
                    </div>
                </div>
            </div>
        </div>
